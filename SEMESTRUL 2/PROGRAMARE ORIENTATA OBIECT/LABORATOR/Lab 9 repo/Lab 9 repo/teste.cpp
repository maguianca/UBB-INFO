...
void test_cos()
{
	...
	string fisier_csv = "C:\\Programare orientata obiect\\Lab 9 repo\\Lab 9 repo\\oferte.csv";
	string fisier_html = "C:\\Programare orientata obiect\\Lab 9 repo\\Lab 9 repo\\oferte.html";
	string fisier_alt = "C:\\Programare orientata obiect\\Lab 9 repo\\Lab 9 repo\\test1222.txt";
...
void test_fisier()
{
	RepoFile repo{ "C:\\Programare orientata obiect\\Lab 9 repo\\Lab 9 repo\\test.txt" };
	Validator valid;
	CosOferte cos;
	Service service{ repo, valid, cos };
	assert(service.get_all().size() == 2);
