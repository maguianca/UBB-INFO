...
void UI::sortare_destinatieUI()
{
    ...
    for (const Turism& l : service.sortare(sort_destinatie))
        cout << "DENUMIRE:" << l.get_denumire() << "\tDESTINATIE: " << l.get_destinatie() << "\tTIP: " << l.get_tip() << "\tPRET: " << l.get_pret() << " euro\n";
...
{
    cout << "SORTARE DESTINATIE\n";
    for (const Turism& l : service.sortare(sort_denumire))
        cout << "DENUMIRE:" << l.get_denumire() << "\tDESTINATIE: " << l.get_destinatie() << "\tTIP: " << l.get_tip() << "\tPRET: " << l.get_pret() << " euro\n";
...
void UI::sortare_tip_pretUI()
{
    ...
    for (const Turism& l : service.sortare(sort_tip_pret))
        cout << "DENUMIRE:" << l.get_denumire() << "\tDESTINATIE: " << l.get_destinatie() << "\tTIP: " << l.get_tip() << "\tPRET: " << l.get_pret() << " euro\n";
...
void UI::cosExportUI()
{
    ...
    cin >> filename;
    string referinta = "C:\\Programare orientata obiect\\Lab 9 repo\\Lab 9 repo\\wishlist\\";
