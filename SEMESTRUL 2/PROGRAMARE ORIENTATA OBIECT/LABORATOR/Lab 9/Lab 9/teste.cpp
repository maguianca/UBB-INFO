...
void test_cos()
{
	...
	string fisier_csv = "C:\\Programare orientata obiect\\Lab 9\\Lab 9\\oferte.csv";
	string fisier_html = "C:\\Programare orientata obiect\\Lab 9\\Lab 9\\oferte.html";
	string fisier_alt = "C:\\Programare orientata obiect\\Lab 9\\Lab 9\\test1222.txt";
	...
	try {
		...
		assert(exception.get_mesaj() == "Fisierul nu este valid!");
		assert(true);
	}
}
...
void test_fisier()
{
	RepoFile repo{ "C:\\Programare orientata obiect\\Lab 9\\Lab 9\\test.txt" };
	Validator valid;
	CosOferte cos;
	Service service{ repo, valid, cos };
	assert(service.get_all().size() == 2);
