	...
	*/
	...
	if (tipul != 2 && tipul != 1)
		...
		if (ascensiune != 1 && ascensiune != 2)
			...
			{
				if (ascensiune == 1)
					new_l4 = service_sortare_2(lista_buget, comparesuma_c);
				else
					new_l4 = service_sortare_2(lista_buget, comparesuma_d);
			}
			else
			{
				if (ascensiune == 1)
					new_l4=service_sortare_2(lista_buget, comparetip_c);
				else
					new_l4=service_sortare_2(lista_buget, comparetip_d);
			}
