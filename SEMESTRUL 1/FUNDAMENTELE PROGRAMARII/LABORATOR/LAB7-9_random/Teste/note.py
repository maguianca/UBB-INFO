...
class TesteN:
    ...
    def __test_create_nota(self):
        student= Student(15, 'Anca', 20)
        laborator = Laborator(14, 'aplicatie', '12/12/2023')
    ...
    def __test_equal_note(self):
        ...
        laborator = Laborator(5, 'app', 12/12/2025)
    ...
    def __test_asignare_laborator(self):
        ...
        nota=business_note.asignare_laborator(1,5)
        assert nota.get_nota()==0
        assert nota.get_student()==student
        assert nota.get_laborator()==laborator
    def __test_asignare_nota_2(self):
        ...
        try:
            ex = business_note.asignare_laborator(1, 5)
        except Exception as ex:
            print()
    ...
    def __test_cautare_dupa_id(self):
        ...
        i=repo_nota.cautare_dupa_id(1,5)
    ...
    def __test_raport_problema(self):
        ...
        validator_note = ValidatorNote()
        business_note = NoteBusiness(repo_laborator, repo_studenti, repo_note, validator_note)
        nota5=business_note.asignare_laborator(4,5)
        nota1=business_note.asignare_laborator(1,5)
        nota2=business_note.asignare_laborator(1,6)
        nota3=business_note.asignare_laborator(2,5)
        nota4=business_note.asignare_laborator(3,5)
        test4=business_note.notare_laborator(4,5,8)
        test = business_note.notare_laborator(1, 5, 5)
        test1= business_note.notare_laborator(2,5,10)
        test3=business_note.notare_laborator(3,5,7)
        x=business_note.raport_problema(5)
    ...
    def __test_raport_corigenti(self):
        ...
        nota3 = business_note.asignare_laborator(2, 5)
        nota4 = business_note.asignare_laborator(3, 5)
        test4 = business_note.notare_laborator(4, 5, 2)
        test = business_note.notare_laborator(1, 5, 7)
        test5=business_note.notare_laborator(1,6,2)
        test1 = business_note.notare_laborator(2, 5, 10)
        test3 = business_note.notare_laborator(3, 5, 7)
        #Anca-4.5 Ema-2
