...
class TesteS:
    def __test_create_student(self):
        ...
        other_nume = "Anca"
        other_grup = 9
        other_student = Student(other_id_student, other_nume, other_grup)
    ...
    def __test_validate_student(self):
        ...
        bad_grup = -9
        epsilon = 0.0001
        bad_student = Student(bad_id_student, bad_nume, bad_grup)
    ...
    def __test_cautare_student(self):
        id_student = 2301
        nume = "Anca"
        grup = 9
        student = Student(id_student, nume, grup)
        ...
        repo.add_student(student)
        repo.add_student(other_student)
        stud=repo.cauta_id(id_student)
        assert stud.get_nume()==nume
        assert stud.get_grup()==grup
        stud1=repo.cauta_id(other_id_student)
        assert stud1.get_nume()==other_nume
        assert stud1.get_grup()==other_grup
