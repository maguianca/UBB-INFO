...
class TesteL:
    ...
    def __test_cautare_laborator(self):
        numar = '1_1'
        descriere = "aplicatie"
        deadline = "12/10/2023"
        laborator = Laborator(numar, descriere, deadline)
        ...
        repo.add_laborator(laborator)
        repo.add_laborator(other_laborator)
        lab1=repo.cauta_numar(numar)
        assert lab1.get_deadline()==deadline
        assert lab1.get_descriere()==descriere
        lab2=repo.cauta_numar(other_numar)
        assert lab2.get_deadline() == other_deadline
        assert lab2.get_descriere() == other_descriere
