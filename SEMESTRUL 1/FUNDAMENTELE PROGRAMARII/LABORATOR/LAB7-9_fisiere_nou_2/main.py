...
def main():
    ...
    repo = FileRepoStudenti("C:\\LAB7-9_fisiere_nou_2\\Infrastructura\\studenti.txt")
    a=TesteN()
    a.run_all_tests()
    s = TesteS()
    s.run_all_tests()
    ...
    l = TesteL()
    l.run_all_tests()
    repos = FileRepoLaborator("C:\\LAB7-9_fisiere_nou_2\\Infrastructura\\laboratoare.txt")
    #repos=LaboratorRepository()
    repon=FileRepoNote("C:\\LAB7-9_fisiere_nou_2\\Infrastructura\\note.txt")
