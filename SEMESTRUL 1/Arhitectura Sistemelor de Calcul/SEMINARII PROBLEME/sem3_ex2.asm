...
; 2. Se da un sir de caractere S format din litere mici.
; Sa se construiasca un sir de caractere D care contine
; literele din șirul inițial transformate în majuscule.
