...
import java.util.Optional;
import java.time.LocalDateTime;
public class DBRequestRepo implements Repository<Long, Friendship> {
    ...
    public DBRequestRepo(Validator<Friendship> validator) {
    ...
    public Optional<Friendship> save(Friendship entity) {
        ...
        String query = "INSERT INTO request(id, id_friend1, id_friend2, date) VALUES (?,?,?,?)";
