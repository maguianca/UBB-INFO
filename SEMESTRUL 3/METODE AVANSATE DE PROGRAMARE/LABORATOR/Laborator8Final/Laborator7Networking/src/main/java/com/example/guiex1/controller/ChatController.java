...
public class ChatController implements Observer<MessageEntityChangeEvent> {
    ...
    /*private void loadChatHistory(Utilizator selectedFriend) {
        ...
        System.out.println("Conversation with " + selectedFriend.getUsername() + ": " + conversation);
    ...
    public void sendMessage(ActionEvent actionEvent) {
        ...
        //String formattedMessage = String.format("%50s%n", utilizator.getUsername() + ": " + messageText);
