...
public class DBUserRepo implements Repository<Long, Utilizator>{
    ...
    public Optional<Utilizator> findOne(Long id) {
        ...
        try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            while (resultSet.next()) {
                ...
                user = new Utilizator(firstName, lastName,password,username);
                user.setId(id);
            }
    ...
    public Iterable<Utilizator> findAll() {
        ...
        try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            while (resultSet.next()) {
                ...
                String password = resultSet.getString("password");
                String username = resultSet.getString("username");
                Utilizator user = new Utilizator(nume, prenume,password,username);
                user.setId(id);
    ...
    public Optional<Utilizator> save(Utilizator entity) {
        ...
        String query = "INSERT INTO users(user_id, first_name, last_name,password,username) VALUES (?, ?, ?,?,?)";
        try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
             PreparedStatement statement = connection.prepareStatement(query)) {
    ...
    public Optional<Utilizator> update(Utilizator entity) {
        ...
        String query = "UPDATE users SET first_name = ?, last_name = ?, password=?, username=? WHERE user_id = ?";
