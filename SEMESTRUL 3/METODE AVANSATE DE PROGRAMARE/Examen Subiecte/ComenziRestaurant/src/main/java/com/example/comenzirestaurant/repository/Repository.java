...
import com.example.comenzirestaurant.domeniu.Entity;
import com.example.comenzirestaurant.validator.*;
...
public interface Repository<ID, E extends Entity<ID>> {
    ...
    //Page<ID> getPagedFriendsForUserID(ID userID, Pageable pageable);
}
