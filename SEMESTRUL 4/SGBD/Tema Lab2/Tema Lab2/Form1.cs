...
namespace Tema_Lab2
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            if (names.Length < childNumberOfColumns)
            {
                MessageBox.Show($"Config incorectă: ai {names.Length} nume de coloane, dar {childNumberOfColumns} coloane așteptate.");
                return;
            }
        ...
        private void dataGridViewParent_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string id_borderou = dataGridViewParent.Rows[e.RowIndex].Cells[0].Value.ToString();


            //Fel_De_Mancare

            /*da.SelectCommand = new SqlCommand("SELECT * from " + childName +
                    " where " + childName + "." + childToParentID + " = " + id_borderou + "; ", cs);*/
            da.SelectCommand = new SqlCommand("SELECT * from Bijuterie where id_borderou=@id_borderou", cs);
            da.SelectCommand.Parameters.AddWithValue("@id_borderou", id_borderou);
            dsC.Clear();
            da.Fill(dsC);
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            da.InsertCommand.Parameters.Add("@id_b",
